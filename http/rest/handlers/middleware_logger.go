...
// This type will implement http.ResponseWriter
...
// MiddlewareLogger logs the incoming HTTP request and response. Enable it only for debug purpose disable it on production.
